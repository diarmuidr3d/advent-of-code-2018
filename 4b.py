input = """[1518-11-22 00:00] Guard #1231 begins shift
...
for guard in guard_times_asleep.keys():
    ...
    minute_of_max_sleep, max_minutes = get_max_minute(minutes)
    if max_minutes > current_max_mins:
        guard_max_mins_asleep = guard
        current_max_mins = max_minutes
        min_of_max_sleep = minute_of_max_sleep
